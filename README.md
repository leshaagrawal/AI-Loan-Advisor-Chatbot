...
## 6. Notes
-   I deliberately chose a zero-dependency single-file architecture because the assignment explicitly asked to prioritize clarity over complexity. There's no build step, no npm install, no server needed — the evaluator can open it in a browser and it works instantly.
